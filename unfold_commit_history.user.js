...
// see end of file for unsandboxing code
if (location.hostname.slice(0, 7) === 'github.') (function exit_sandbox() {
// manual host check - @match patterns only handle *.github.com, not github.* :(
